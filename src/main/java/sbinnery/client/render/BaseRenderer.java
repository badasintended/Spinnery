...
import sbinnery.mixin.TextRendererAccessor;
...
public class BaseRenderer {
	...
	public static AdvancedTextRenderer getAdvancedTextRenderer() {
		...
		advancedTextRenderer.setFontStorageAccessor(((TextRendererAccessor) defaultRenderer).getFontStorageAccessor());
		advancedTextRenderer.setHandler(((TextRendererAccessor) defaultRenderer).getHandler());
