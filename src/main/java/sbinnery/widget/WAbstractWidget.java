...
import sbinnery.widget.api.listener.*;

import java.util.List;

import static sbinnery.common.registry.ThemeRegistry.DEFAULT_THEME;
...
public abstract class WAbstractWidget implements Tickable, WLayoutElement, WThemable, WStyleProvider, WEventListener {
	...
	public void drawTooltip(MatrixStack matrices, VertexConsumerProvider.Immediate provider) {
		...
		sbinnery.client.render.BaseRenderer.drawTooltip(matrices, provider, x, y + 1, width - 1, height - 1, Color.of(0xf0140617), Color.of(0xf0120418), Color.of(0xf0140617), Color.of(0xf0120412), Color.of(0x50270460), Color.of(0x50190333));
